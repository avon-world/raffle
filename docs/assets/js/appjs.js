...
/*
 ...
 !------ Fix 10.02.2018 by ProjectSoft -------!
 Fix conflicts on events with fancybox 3
...
(function($) {
		...
		init_el: function($this, options) {
			...
			var o = $.extend(true, {
				...
				success: function(responce) {
					...
					$this.trigger('afterLoading.arcticmodal');
					...
					$this.trigger('afterLoadingOnShow.arcticmodal');
				...
				error: function() {
					...
					$this.trigger('errorLoading.arcticmodal');
	...
	var actions = {
		...
		show: function() {
			...
			// Событие
			D.beforeOpen(D, $this);
			$this.trigger('beforeOpen.arcticmodal');
			...
			modal.transition(D.container.block, 'show', modals.length>1 ? {type: 'none'} : D.openEffect, function() {
				D.afterOpen(D, $this);
				$this.trigger('afterOpen.arcticmodal');
			});
		...
		close: function() {
			if ($.isFunction(this)) {
				...
				return this.each(function() {
					...
					$this.trigger('beforeClose.arcticmodal');
					...
					modal.transition(D.container.block, 'hide', modals.length>1 ? {type: 'none'} : D.closeEffect, function() {
						...
						D.afterClose(D, $this);
						$this.trigger('afterClose.arcticmodal');
...
/*! raffle v2.0.3 | ISC License | https://github.com/avon-world/raffle */
